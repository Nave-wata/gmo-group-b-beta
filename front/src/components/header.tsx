            ...
            <Link type="button" className="d-flex btn btn-outline-secondary me-1" href="/profile">
                {session?.user?.image != null ?
                    <img src={session?.user?.image}
                         style={{borderRadius: "50%", height: 24, position: "relative",top:5}}/>:
            ...
            <div>
                <button className="nav-link btn mx-2 btn-outline-secondary" onClick={() => signOut()}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                         className="bi bi-box-arrow-right m-1" viewBox="0 0 16 16">
        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
                <div className="container-fluid p-2">
                    <div className="">
                        <Link className="navbar-brand ms-3" href="/home"><img src={"./icon.webp"} style={{width: 200}}/></Link>
